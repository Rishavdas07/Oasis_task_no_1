            ...
            while (true) {
                ...
                if (guess == NumberToGuess) {
                    ...
                    if(NumberOfGuesses <= 5){
                        ...
                        System.out.println(" ");
                        System.out.println("Your luck is struggling!!");
                    ...
                    System.out.println("Hint:-Your guess is too less...Try again.");
                    System.out.print("Enter a valid number:");

                    RoundScore -= 1;
                } else {
                    System.out.println("Hint:-Your guess is too large...Try again.");
                    System.out.print("Enter a valid number:");
                    RoundScore -= 1;
                }

                if(NumberOfGuesses==10){
                    System.out.println("Sorry You've failed to guess the number in 10 trials!!");
